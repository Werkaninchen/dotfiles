...
if [ $(grep -c 'set background=light' $HOME/.vimrc) -ne 0 ]; then
	...
	sed -i 's/solarized-light solarized-dark/solarized-dark solarized-light/g' $HOME/.spacemacs
	...
	sed -i 's/solarized-dark solarized-light/solarized-light solarized-dark/g' $HOME/.spacemacs
